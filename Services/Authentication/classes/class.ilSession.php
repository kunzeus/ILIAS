...
class ilSession
{
    ...
    * Destroy session
    *
    * @param	string|array $session_id      session id|s
    * @param	int|null     $closing_context closing context
    * @param	int|bool     $expired_at      expired at timestamp
    */
    public static function _destroy($session_id, ?int $closing_context = null, $expired_at = null): bool
    {
    ...
    */
    ...
    {
        return self::getBackend()->getActiveUserIds();
    }
